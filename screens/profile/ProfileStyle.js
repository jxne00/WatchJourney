...
const ProfileStyles = () => {
  ...
  return StyleSheet.create({
    ...
    profile: {
      ...
      margin: 10,
      padding: 14,
      backgroundColor: theme === 'light' ? '#c8d6e8' : '#37393c',
      borderWidth: 1,
      borderColor: theme === 'light' ? '#000' : '#a4adb9',
      borderRadius: 16,
      shadowColor: theme === 'light' ? '#000' : '#5d5d5d',
      elevation: 4,
    ...
    signoutBtn: {
      ...
      paddingVertical: 12,
      borderRadius: 23,
      backgroundColor: theme === 'light' ? PRIMARY_COL : '#783f80',
    },
    SignoutBtnText: {
      color: '#fff',
      fontSize: 16,
